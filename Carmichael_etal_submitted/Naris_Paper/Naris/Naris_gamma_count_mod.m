...
if exist(PARAMS.naris_gamma_inter_dir,'file') ~=2 % check to make sure on exists
    naris_gamma = [];    %if not make an empty file. 
    
else
    load(PARAMS.naris_gamma_inter_dir);
end
...
save(PARAMS.naris_gamma_inter_dir, 'naris_gamma', '-v7.3');
