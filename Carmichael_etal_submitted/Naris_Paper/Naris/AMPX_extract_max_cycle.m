function [cycle, h_cycle] = AMPX_extract_max_cycle(cfg_in, data_filt)
...
% if ~isfield(cfg_in, 'chan')
%     cfg_in.chan = 1;
% elseif CheckTSD(data_filt)
%         cfg_in.chan = 1;
        data_filt.hdr.Fs = data_filt.cfg.hdr{1}.SamplingFrequency;
% end
phase = -angle(hilbert(data_filt.data(cfg_in.chan,:)));
