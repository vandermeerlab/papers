function [data_in] = AMPX_Naris_pipeline_fix_cycles(fname,data_in, varargin)
...
% end
% evts.low = data_in.lg.evts;
% evts.high = data_in.hg.evts;
% evts.ctrl_low = data_in.lg_ran.evts;
% evts.ctrl_high = data_in.hg_ran.evts;
...
%     cfg = [];
%     cfg.freq = [40 55];
%     data_out.lg_ran.cycles = AMPX_get_3cycles(cfg, evts.ctrl_low, data_remap_AMPX, ExpKeys_remap);
%     
%     % high control
%     cfg =[];
%     cfg.freq = [70 85];
...
% end
% data_in.lg.cycles = data_out.lg.cycles;
% data_in.hg.cycles = data_out.hg.cycles;
% data_in.lg_ran.cycles = data_out.lg_ran.cycles;
data_in.spindles = data_out.spindles;
% 
% data_in.lg.cycles_phase = data_out.lg.cycles_phase;
% data_in.hg.cycles_phase = data_out.hg.cycles_phase;
% data_in.lg_ran.cycles_phase = data_out.lg_ran.cycles_phase;
% data_in.hg_ran.cycles_phase = data_out.hg_ran.cycles_phase;
