...
clear fd;
data_root = 'D:\data';
SessionLIST = {'R026-2013-04-19', 'R026-2013-04-20', 'R032-2013-05-22', 'R032-2013-05-31', ...
...
PARAM_chew_thr = 1; % z-score of chew band envelope must be smaller than this, default 0.25
...
for iFD = 1:length(fd)
    ...
    cfg_chew.filter_cfg.f = [125 300]; % default [200 300]
