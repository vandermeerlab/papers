...
cfg_master.TCsmooth = [0 0.1 0.25 0.5 1 3 5 7.5 10 15]; % SD of Gaussian smoothing kernel for tuning curves
cfg_master.QsmoothSD = [0 0.002 0.005 0.01 0.015 0.025 0.05 0.1 0.2 0.5 1 2 5]; % SD of Gaussian kernel for SDFs
